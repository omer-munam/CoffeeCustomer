...
public class FavoriteListing extends ArrayAdapter<JSONObject>
{
    ...
    SharePrefsEntry sp;
    ConnectionClass cc;
    public FavoriteListing(Activity con, ArrayList<JSONObject> l)
    {
    ...
    public View getView(final int paramInt, View convertView, ViewGroup parent)
    {
        try
        {
            ...
            final String storeid                    = splittedKey[2];
            final String locid                      = splittedKey[1];
            final String catid                      = splittedKey[3];
            final String subcatid                   = splittedKey[4];
            ...
            viewHolder.price.setText(DEF_CURRENCY+function.round2decimal(Float.parseFloat(jsonObject.getString("price"))));
