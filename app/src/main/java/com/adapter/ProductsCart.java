...
import static com.tam.winati.ksa.ViewCart.deliveryTime;
import static com.utils.Constants.DEF_CURRENCY;
import static com.utils.Constants.itemMap;


public class ProductsCart extends ArrayAdapter<JSONObject>
{
    Activity context;
    Functions function;
    ...
    public ProductsCart(Activity con, ArrayList<JSONObject> jobj)
    {
